...
WebUI.navigateToUrl('http://10.0.0.129:3000/login')

WebUI.setText(findTestObject('Object Repository/LoginOTP/Page_EHR - Electronic Healthcare/input_Email___BVID__17'), 'nisaevifauziah@gmail.com')
